...
<!-- Kết thúc phần header -->
    ...
    <section class="u-align-center u-border-1 u-border-grey-75 u-clearfix u-section-1" id="sec-4b4c">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-1">PHIẾU NHẬP KHO</h2>
        <div class="u-form u-form-1">
          <!-- Form nhập phiếu -->
          <form method="POST" action="phpCSDL/NhapDuLieuCSDL.php" style="padding: 10px;" source="custom" name="form">
              <!-- Ngày nhập -->
            <div class="u-form-date u-form-group u-form-partition-factor-2">
              <label>Ngày nhập</label>
              <input type="date" id="dtNgayNhap" name="NgayNhap" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10">
            </div>
              <!-- Nhân viên -->
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <!-- Nút Lưu -->     
              <input type = "submit" name = "submit" value = "Nhập" class= "u-btn u-btn-submit"/>     
            </div>   
          </form>
        </div>
        ...
        <h2 class="u-text u-text-1">THÔNG TIN PHIẾU NHẬP</h2>
          <!-- Nút tìm kiếm -->
          ...
          <table id = "dataTable" class="u-table-entity" style="margin-top: 20px;">
            <thead class="u-align-center u-palette-5-base u-table-header u-table-header-1">
              ...
              <?php
                 $STT = 1;
                 $result = $conn->query("SELECT ct.CTN_MaSP, lsp.LSP_TenloaiSP, sp.SP_TenSP, sp.SP_Donvi, ct.CTN_SoLuong, sp.SP_Price, pn.PN_Ngaylap ,nv.NV_HoTen 
                                          FROM phieunhap pn, chitietphieunhap ct, sanpham sp, nhanvien nv, loaisanpham lsp
                                          WHERE pn.PN_MaPN = ct.CTN_MaPN 
                                                AND ct.CTN_MaSP = sp.SP_MaSP 
                                                AND pn.PN_ID = nv.NV_ID 
